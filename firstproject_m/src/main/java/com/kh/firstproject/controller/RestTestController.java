...
public class RestTestController {
	...
	// 인증키
	/* * 
	 * aCz34R3ycz%2B0IcuBdueR1Qzo7wICjHTJowOpM9iFLFXvD5K718SqKMB34EP9zkf%2ByDq0pKCI1L5FIaI8Mzf78A%3D%3D
	 * 
	 */
	...
	// resource > static > libs 생성 > json.jar 파일 채로 넣음 
	// add build path로 넣어줘야 적용됨
	@GetMapping("/jsonapi")
